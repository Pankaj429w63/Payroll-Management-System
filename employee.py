...
class EmployeeSystem:
    def __init__(self,root):
        self.root=root
        self.root.title("Employee Payroll Management System | Developed By Pankaj,raj and inesh | Webcode")
        ...
        txt_designation=Entry(Frame1,font=("times new roman",15),textvariable=self.var_designation,bg="lightyellow",fg="black").place(x=170,y=120,width=200)
        ...
        lbl_doj=Label(Frame1,text="D.O.J",font=("times new roman",20),bg="white",fg="black").place(x=390,y=160)
    ...
    #row5**
        ...
        lbl_contact=Label(Frame1,text="Contact",font=("times new roman",20),bg="white",fg="black").place(x=390,y=370)
        txt_contact=Entry(Frame1,font=("times new roman",15),textvariable=self.var_contact,bg="lightyellow",fg="black").place(x=520,y=375)
        ...
        lbl_status=Label(Frame1,text="Status",font=("times new roman",20),bg="white",fg="black").place(x=390,y=320)
        txt_status=Entry(Frame1,font=("times new roman",15),textvariable=self.var_status,bg="lightyellow",fg="black").place(x=520,y=325)
       ...
       #row3***
        ...
        btn_calculate=Button(Frame2,text="Calculate",command=self.calculate,font=("times new roman",20),bg="orange",fg="black").place(x=150,y=220,height=30,width=120)
        self.btn_save=Button(Frame2,text="Save",font=("times new roman",20),bg="green",fg="white")
        self.btn_save.place(x=285,y=220,height=30,width=120)
        btn_clear=Button(Frame2,text="Clear",command=self.clear,font=("times new roman",20),bg="grey",fg="black").place(x=420,y=220,height=30,width=120)
    ...
    def search(self):
        try:
            ...
            if rows==None:
                ...
                self.var_hr_location.set(rows[6])
                ...
                file_=open('Salary_reciept/'+str(rows[23]),'w')
    ...
    def update(self):
          if self.var_emp_code.get()=='' or self.var_net_salary.get()=='' or self.var_name.get()=='':
            ...
            try:
                ...
                # print(rows)
                if rows==None:
                    messagebox.showerror("Error","this Employee ID is invalid,try again with another ID,try again with valid Employee ID",parent=self.root) 
                else:
...
----------------------------------------
 ...
 Medicalt\t\t:  Rs.{self.var_medical.get()}
...
''' 
    ...
    def employee_frame(self):
        ...
        self.root2.title("Employee Payroll Management System | Developed By Pankaj,raj and inesh | Webcode")
        ...
        self.employee_tree.heading('desigation',text='Designation')
